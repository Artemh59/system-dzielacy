...
- **Najmniejsza dodatnia:** ≈ 2.2 × 10⁻³⁰⁸
- **Największa dodatnia:** ≈ 1.8 × 10³⁰⁸
- **Precyzja:** około 15-17 cyfr dziesiętnych

### Dlaczego 52 bity mantysy?

```
2^52 ≈ 4.5 × 10¹⁵
```

Możemy dokładnie reprezentować wszystkie liczby całkowite do **2⁵³ − 1**.
...
1. **IEEE 754** to standard reprezentacji liczb zmiennoprzecinkowych
2. **64 bity** = 1 bit znaku + 11 bitów wykładnika + 52 bity mantysy
3. **Formuła**: Wartość = (−1)^S × 2^(E−1023) × (1 + M)
4. **Dzielenie**: Odejmujemy wykładniki, dzielimy mantysy
5. **JavaScript** używa tego formatu dla wszystkich liczb

### Dlaczego to ważne?

- Zrozumienie jak komputer przechowuje liczby
- Świadomość ograniczeń precyzji (0.1 + 0.2 ≠ 0.3)
- Podstawa do zaawansowanych operacji numerycznych
- Debugowanie problemów z zaokrągleniami
...
- [IEEE 754 Calculator](https://www.h-schmidt.net/FloatConverter/)

---

**Dokumentacja stworzona dla projektu: Symulator Dzielenia Binarnego 64-bitowego**
